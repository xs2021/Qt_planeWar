...
#define GAME_TITLE "飞机大战 v1.0 小帅" //标题
#define GAME_RES_PATH  "./plane.rcc" //rcc二进制文件路径
#define GAME_ICON  ":/res/app.ico" //图标资源
#define GAME_RATE  10   //刷新间隔，帧率 单位毫秒

/**********  配置数据 **********/
#define MAP_PATH ":/res/img_bg_level_2"  //地图场景路径
...
/**********  文件配置数据 **********/
#define FILE_PATH "D:\\ScoreFile.txt"
